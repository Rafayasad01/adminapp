        ...
        <div ref={ref}>
          <div className="print-area">
            ...
            <div className="print-row">
              ...
              <div className="col-2">
                <span>
                  {detailItems?.appointmentService?.map(
                    (item: any, i: number) => {
                      return <span key={i}> ${item.fees}</span>;
                    }
                  )}
                </span>
              </div>
            ...
            <div className="print-row">
              ...
              <div className="col-2">
                <span>PKR {detailItems?.totalAmount}</span>
              </div>
            </div>
            <div className="print-row">
              <div className="col-1">
              ...
              <div className="col-2">
                <span>PKR {detailItems?.gstAmount}</span>
              </div>
            </div>
            <div className="print-line straight" />
            <div className="print-row">
              ...
              <div className="col-2">
                <span>PKR {detailItems?.grandTotal}</span>
              </div>
            </div>
            <div className="print-line" />

...
export const ALL_PERMISSIONS = {
  storeAppointment: {
    ...
    viewEmployeeAttendance: 'viewAppointmentAttendanceRating',
  ...
  storeProduct: {
    ...
    loyaltyCoinsItem: 'loyaltyCoinsProductItem',
  ...
  storeUser: {
    viewAppUser: 'viewStoreProduct',
    viewAdminUser: 'viewProductOrder',
  },
  storeBranch: {

...
export const CURRENCY_PREFIX = import.meta.env.VITE_CURRENCY_SYMBOL;
...
export const ALL_PERMISSIONS = {
  ...
  storePlans: {
    ...
    viewProjectPlans: 'viewProjectPlans',
    addProjectPlan: 'addProjectPlan',
    editProjectPlan: 'editProjectPlan',
    deleteProjectPlan: 'deleteProjectPlan',
    viewVideoPlans: 'viewVideoPlans',
    addVideoPlans: 'addVideoPlans',
    editVideoPlans: 'editVideoPlans',
    deleteVideoPlans: 'deleteVideoPlans',
    viewImagesPlans: 'viewImagesPlans',
    addImagesPlans: 'addImagesPlans',
    editImagesPlans: 'editImagesPlans',
    deleteImagesPlans: 'deleteImagesPlans',
    viewDocsPlans: 'viewDocsPlans',
    addDocsPlans: 'addDocsPlans',
    editDocsPlans: 'editDocsPlans',
    deleteDocsPlans: 'deleteDocsPlans',
    viewProjectUsers: 'viewProjectUsers',
    addProjectUsers: 'addProjectUsers',
    editProjectUsers: 'editProjectUsers',
    deleteProjectUsers: 'deleteProjectUsers',
    viewProjectAdminUsers: 'viewProjectAdminUsers',
    addProjectAdminUsers: 'addProjectAdminUsers',
    editProjectAdminUsers: 'editProjectAdminUsers',
    deleteProjectAdminUsers: 'deleteProjectAdminUsers',
    viewProjectAttachments: 'viewProjectAttachments',
    addProjectAttachments: 'addProjectAttachments',
    editProjectAttachments: 'editProjectAttachments',

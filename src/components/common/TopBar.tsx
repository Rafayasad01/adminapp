      ...
      <div className="fixed top-0 z-10 mx-0 w-[100%] bg-[#f5f5f5]">
        <div className="mb-4 flex w-[100%] items-center justify-between px-2 pb-1 pt-2">
          <div className="basis-[50%] px-6">
            <span className="block font-space-grotesk text-[32px] font-medium capitalize leading-normal text-secondary">
              Hello New Earth Proptech
            </span>
            <span className="block font-space-grotesk text-[14px] font-medium capitalize leading-normal text-secondary">
              Admin Dashboard
            </span>
          </div>
            ...
            <div className="flex items-center justify-end gap-4">
              <div className="px-2">
                <div className="h-[35px] w-[100px] rounded-[20px] bg-white p-2 text-center hover:bg-[#ccc]">
                  <span className="block font-space-grotesk text-[12px] font-medium leading-normal text-secondary">
              ...
              <div className="pr-4">
                <div className="w-[100px]  rounded-[20px]  text-center">
                  <span className="block w-full text-left font-space-grotesk text-[12px] font-medium capitalize leading-normal text-secondary">

...
const CustomTable = ({ tableHeader, tableDataTitle, list, setList,
    isSearch, isAddButton, actions, search, setSearch, service,
    handleFormClickOpen, handleClickSearch, actionMenuOpen, setActionMenuAnchorEl,
    setActionMenuItemid, page, setPage, total, setTotal, rowsPerPage, setRowsPerPage
}: Props) => {
    ...
    const handleSwitchChange = (event: any, id: string) => {
        ...
        service.updateStatus(id, data).then((updateItem: any) => {

...
function BonusPage() {
  ...
  const handleFormClickOpen = () => {
    if (listingRolePermission(dataRole, ALL_PERMISSIONS.storeBonus.add)) {
  ...
  const manuHandler = (option: string) => {
    if (option === 'Edit') {
      if (listingRolePermission(dataRole, ALL_PERMISSIONS.storeBonus.edit)) {
      ...
      if (listingRolePermission(dataRole, ALL_PERMISSIONS.storeBonus.delete)) {

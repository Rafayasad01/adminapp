...
function OvertimePage() {
  ...
  const handleFormClickOpen = () => {
    if (listingRolePermission(dataRole, ALL_PERMISSIONS.storeOvertime.add)) {
  ...
  const manuHandler = (option: string) => {
    if (option === 'Edit') {
      if (listingRolePermission(dataRole, ALL_PERMISSIONS.storeOvertime.edit)) {
      ...
      if (
        listingRolePermission(dataRole, ALL_PERMISSIONS.storeOvertime.delete)
      ) {
                  ...
                  list.map((item: any, index: number) => {
                    return (
                      <tr key={index}>
                        ...
                        <td>
                          {item.overtimeHours ? item.overtimeHours : '--'}
                        </td>
                        <td>

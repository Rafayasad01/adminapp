...
function DeductionPage() {
  ...
  const handleFormClickOpen = () => {
    if (listingRolePermission(dataRole, ALL_PERMISSIONS.storeDeduction.add)) {
  ...
  useEffect(() => {
    if (listingRolePermission(dataRole, ALL_PERMISSIONS.storeDeduction.view)) {
  ...
  const manuHandler = (option: string) => {
    if (option === 'Edit') {
      if (
        listingRolePermission(dataRole, ALL_PERMISSIONS.storeDeduction.edit)
      ) {
      ...
      if (
        listingRolePermission(dataRole, ALL_PERMISSIONS.storeDeduction.delete)
      ) {

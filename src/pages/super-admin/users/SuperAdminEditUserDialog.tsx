...
import classes from './SuperAdminEditUserDialog.module.css';
...
function SuperAdminEditUserDialog({ openDialog, setOpenDialog }: Props) {
    ...
    >
      <div className={classes.Dialog__Content}>
        <div className={classes.Dialog__Content__FormHeader}>
          <span className={classes.Dialog__Content__Title}>Edit User</span>
        </div>
...
export default SuperAdminEditUserDialog;

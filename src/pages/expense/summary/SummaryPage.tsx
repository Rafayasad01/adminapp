...
import DeductionAddPopup from './SummaryAddPopup';
// import ServiceCatEditPopup from './ServiceCatEditPopup';
import PermissionPopup from '../../../utils/PermissionPopup';
import DeductionEditPopup from './SummaryEditPopup';
...
function SummaryPage() {
  ...
  const getDeductionList = (
    ...
    console.log('🚀 ~ SummaryPage ~ queryParams:', queryParams, id);
    // storeExpense
  ...
  const deleteHandler = (id: string) => {
    ...
    console.log('🚀 ~ SummaryPage ~ queryParams:', id, data);
    // storeExpense

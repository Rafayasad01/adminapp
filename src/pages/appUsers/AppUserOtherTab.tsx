...
const AppUserOtherTab = ({ setRowsPerPage, setTotal, search, setPage, page, total, rowsPerPage, setIsNotify, setNotifyMessage, isNotify, notifyMessage, list, setList, isLoader, setIsLoader, actionMenuItemid, setActionMenuItemid, setEditFormData, setOpenEditFormDialog }: Props) => {
    ...
    const handleChangePage = (
        ...
        if (search === '' || search === null || search === undefined) {
            Service.appList(authState.user.tenant, 'Other', newPage, rowsPerPage).then(
                (item) => {

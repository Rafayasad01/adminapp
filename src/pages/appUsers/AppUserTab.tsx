...
const AppUserTab = ({ setRowsPerPage, setTotal, search, setPage, page, total, rowsPerPage, setIsNotify, setNotifyMessage, isNotify, notifyMessage, list, setList, isLoader, setIsLoader, actionMenuItemid, setActionMenuItemid, setEditFormData, setOpenEditFormDialog }: Props) => {

...
function AppUserPromotionDetailPage() {
  ...
  return isLoader ? (
    ...
    <>
      ...
      />
      <TopBar isNestedRoute title="Reward History Details" />
      {detail && (
        <>
            ...
            <div className="grid grid-cols-12 gap-3">
              ...
              <div className="rounded-lg bg-[#fff] px-4 py-5 shadow-lg xl:col-span-6 2xl:col-span-4">
                <div className="">
                  ...
                  <Divider className="mb-4 mt-1 w-52" />
                </div>
                <div className="flex w-full flex-col">
                  <div className="flex w-full flex-col">
                    <span className="mt-2 font-open-sans text-base font-semibold text-[#1A1A1A]">
                    ...
                    <span className="font-open-sans text-sm font-normal text-[#6A6A6A]">
                      {detail.adminVoucher.voucherCode}
                    </span>
                  </div>
                  <div className="flex w-full flex-col">
                    <span className="mt-2 font-open-sans text-base font-semibold text-[#1A1A1A]">
                    ...
                    <span className="font-open-sans text-sm font-normal text-[#6A6A6A]">
                      {detail.adminVoucher.discountType}
                    </span>
                  </div>
                  <div className="flex w-full flex-col">
                    <span className="mt-2 font-open-sans text-base font-semibold text-[#1A1A1A]">
                  ...
                  <div className="flex w-full flex-col">
                    ...
                    <span className="font-open-sans text-sm font-normal text-[#6A6A6A]">
                      {dayjs(detail.createdDate).format('MMMM DD, YYYY')}
                    </span>
                  </div>
                </div>
              </div>
...
export default AppUserPromotionDetailPage;

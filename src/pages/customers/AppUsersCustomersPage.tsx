...
import AppUserCreatePopup from './AppUserCustomerCreatePopup';
// import AppUserOtherTab from './AppUserOtherTab';
import AppUserTab from './AppUserCustomerTab';
import AppUserUpdatePopup from './AppUserCustomerUpdatePopup';
// import CustomersCreatePopup from './CustomersCreatePopup';
// import CustomersEditPopup from './CustomersEditPopup';

function AppUsersCustomerPage() {
  ...
  const handleFormClickOpen = () => {
    if (
      listingRolePermission(
        dataRole,
        ALL_PERMISSIONS.storeUser.viewAddressCustomer
      )
    ) {
...
export default AppUsersCustomerPage;

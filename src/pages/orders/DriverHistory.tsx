    ...
    return isLoader ? (
        ...
        <>
            ...
            <div className="container m-auto py-3">
                <div className="min-h-[300px] rounded-lg bg-[#fff] shadow-lg p-5">
                        ...
                        <div className="Content grid grid-cols-6 items-end">
                            ...
                            <div className="col-span-4 flex justify-end">
                                ...
                                <CustomButton
                                    ...
                                    title='Amount loan'
                                    buttonType='button'
                                    className="bg-red-700 ml-3 w-60"
                                    onclick={() => {
                                        setDialogText(
                                            'Are you sure you want to update this amount'
                                        );
                    ...
                    <div className="mt-6">
                        ...
                        <div className="grid grid-cols-12 gap-8 my-4">
                            <div className="col-span-3">
                                ...
                                <span className="text-[#1A1A1A] text-md font-semibold">Andrew Michael</span>
                            </div>
                            <div className="col-span-3">
                            ...
                            <div className="col-span-6">
                                ...
                                <span className="text-[#1A1A1A] text-md font-semibold">Scelerisque maecenas sodales fusce placerat hac augue</span>
                            </div>
                            <div className="col-span-3">

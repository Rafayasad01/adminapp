...
function DriversPage() {
  ...
  // functions handling
  const handleFormClickOpen = () => setOpenFormDialog(true);
  ...
  const onSubmitDialogBox = (data: AppUserDriverExt) => {
    ...
    } else if (openEditFormDialog && data.first_name && data.last_name && data.email && data.phone && data.license_number) {
      const licenseNumber = data.license_number.replace(/\s+/g, '');
      data.avatar = avatar;
      data.license_number = licenseNumber;
    ...
    <LocalizationProvider dateAdapter={AdapterDayjs}>
      ...
      <div className='flex align-center justify-center'>
        <CustomTable
          ...
          tableDataTitle={["Drivers", "Phone", "Email", "Availability", "License Number", "Status"]}
          list={list}
          setList={setList}
          isSearch={true}
          isAddButton={true}
      ...
      <CustomDialog
        ...
        type={"edit"}
        reset={reset}
        inputFieldsData={openEditFormDialog ? inputFieldsData.filter(item => item.id !== "address" && item.id !== "password") : inputFieldsData}
        handleSubmit={handleSubmit}
        onSubmit={onSubmitDialogBox}

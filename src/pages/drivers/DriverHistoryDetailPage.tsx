...
function DriverHistoryDetailPage() {
  ...
  const { driverId }: any = useParams();
  console.log('🚀 ~ DriverHistoryDetailPage ~ driverId:', driverId);
  const { control, handleSubmit, getValues } = useForm();
  const id: any = driverId;
  ...
  useEffect(() => {
    ...
    setTo(toDate);
    setFrom(fromDate);
    Service.driverDetail(driverId, page, rowsPerPage, toDate, fromDate).then(
      (item) => {

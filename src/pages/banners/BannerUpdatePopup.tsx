                    ...
                    <div className='mt-3'>
                        <FormControl className="FormControl" variant="standard">
                            ...
                            <Input
                                ...
                                disableUnderline
                                {...register('bannerName', { required: true, value: formData?.name })}
                            />
                            {errors.bannerName?.type === 'required' && (
                                <span role="alert" style={{ color: 'red', fontSize: '12px' }}>* Banner name is required</span>
                            )}
                        </FormControl>
                    </div>
                    <div className="grid grid-cols-10 my-3 gap-6">
